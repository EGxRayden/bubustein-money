...
public class MoneyRecipeDataGen extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter){
        ...
        oneToOneConversionRecipe(exporter, ModItems.CCent10.get(), ModItems.Loonie.get(), "", 10);
        ...
        BankMachineRecipeShapedBuilder.shaped(ModItems.DollarC5.get())
                ...
                .define('R', Items.REDSTONE)
                .define('D', ModItems.SpecialPaper.get())
        ...
        BankMachineRecipeShapedBuilder.shaped(ModItems.DollarA5.get())
                ...
                .define('B', ModItems.SpecialPaper.get())
                .define('R', Items.REDSTONE)
        ...
        BankMachineRecipeShapedBuilder.shaped(ModItems.CNYuan1.get())
                .pattern("#O#")
                .pattern("RPI")
                .pattern("O#O")
                .define('#', Items.GREEN_DYE)
