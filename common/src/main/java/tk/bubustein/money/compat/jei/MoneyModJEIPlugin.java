...
public class MoneyModJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        RecipeManager recipeManager = Objects.requireNonNull(Minecraft.getInstance().level.getServer()).getRecipeManager();
        RecipeMap recipeMap = (RecipeMap) recipeManager.getRecipes();
        List<BankMachineRecipe> recipes = Objects.requireNonNull(recipeMap.getRecipesFor(ModRecipes.BANK_MACHINE_RECIPE.get(), null, Minecraft.getInstance().level))
