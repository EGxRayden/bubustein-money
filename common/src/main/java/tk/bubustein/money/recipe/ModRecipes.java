...
public class ModRecipes {
    ...
    public static final DeferredRegister<RecipeDisplay.Type<?>> TYPE = DeferredRegister.create(MoneyMod.MOD_ID, Registries.RECIPE_DISPLAY);
    ...
    public static final RegistrySupplier<RecipeDisplay.Type<BankMachineRecipeShapedDisplay>> BANK_MACHINE_SHAPED_DISPLAY = TYPE.register("bank_machine_shaped", () -> BankMachineRecipeShapedDisplay.TYPE);
    public static final RegistrySupplier<RecipeDisplay.Type<BankMachineRecipeShapelessDisplay>> BANK_MACHINE_SHAPELESS_DISPLAY = TYPE.register("bank_machine_shapeless", () -> BankMachineRecipeShapelessDisplay.TYPE);
