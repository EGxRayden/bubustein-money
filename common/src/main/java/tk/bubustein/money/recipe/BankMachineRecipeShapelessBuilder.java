...
public class BankMachineRecipeShapelessBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation resourceLocation) {
        ...
        consumer.accept(new BankMachineRecipeShapelessBuilder.Result(resourceLocation, this.result, this.count, this.group == null ? "" : this.group, this.ingredients, this.advancement, resourceLocation.withPrefix("recipes/")));
    }
