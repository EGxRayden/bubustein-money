...
public class BankMachineRecipeShaped implements BankMachineRecipe {
    ...
    public static class Serializer implements RecipeSerializer<BankMachineRecipeShaped> {
        ...
        public @NotNull BankMachineRecipeShaped fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
            String string = GsonHelper.getAsString(jsonObject, "group", "");
            Map<String, Ingredient> map = BankMachineRecipeShaped.keyFromJson(GsonHelper.getAsJsonObject(jsonObject, "key"));
            String[] strings = BankMachineRecipeShaped.shrink(BankMachineRecipeShaped.patternFromJson(GsonHelper.getAsJsonArray(jsonObject, "pattern")));
            int i = strings[0].length();
            int j = strings.length;
            NonNullList<Ingredient> nonNullList = BankMachineRecipeShaped.dissolvePattern(strings, map, i, j);
            ...
            return new BankMachineRecipeShaped(resourceLocation, string, i, j, nonNullList, itemStack, bl);
        }
        public @NotNull BankMachineRecipeShaped fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf friendlyByteBuf) {
