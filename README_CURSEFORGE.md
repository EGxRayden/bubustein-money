...
### x.0.10 Beta: New ATM Texture and Model. (Without ATM GUI Sadly) The Cards are not useless anymore. Created a very complicated mechanism with Commands. Use `/bubustein help` to see all commands. Made Mansion less OP. **You need to backup your worlds before installing x.0.10!**
